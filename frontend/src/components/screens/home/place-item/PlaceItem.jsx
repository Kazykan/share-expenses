...
function PlaceItem ({place}) {
  ...
  const  mutation = useMutation({
    ...
    return (
        <div
        className="relative flex flex-col max-w-2xl p-6 divide-y xl:flex-row xl:divide-y-0 xl:divide-x dark:bg-gray-900 dark:text-gray-100 dark:divide-gray-700"
      >
