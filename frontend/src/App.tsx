      ...
      <section className="container px-4 mx-auto">
        ...
        <div className="mt-6 md:flex md:items-center md:justify-between">
          ...
          <div className="inline-flex overflow-hidden bg-white border divide-x rounded-lg dark:bg-gray-900 rtl:flex-row-reverse dark:border-gray-700 dark:divide-gray-700">
            <button className={`px-5 py-2 text-xs font-medium text-gray-600 transition-colors duration-200 sm:text-sm ${headerButton == '1' ? 'bg-gray-100 dark:bg-gray-800 dark:text-gray-300' : 'dark:hover:bg-gray-800 dark:text-gray-300 hover:bg-gray-100'}`}
          ...
          <div className="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
            <div className="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
              <div className="overflow-hidden border border-gray-200 dark:border-gray-700 md:rounded-lg">
                <div className="w-100 h-1.5 bg-blue-200 overflow-hidden rounded-full">
                  <div className="bg-blue-500 w-3/12 h-1.5"></div>
                </div>
              </div>
            </div>
          </div>
                  ...
                  <div className="flex items-center gap-x-2">
                    <div>
                      ...
                      <p className="text-sm font-normal text-gray-600 dark:text-gray-400">
                        {" "}
                        <span className="font-medium"> Лукман </span>
                        <span className="text-gray-500"> 2023-11-25 </span>
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <td className="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                <div className="inline-flex items-center gap-x-3">
                  ...
                  <div className="flex items-center gap-x-2">
                    <div>
                      <h2 className="font-medium text-gray-800 dark:text-white ">
                        Руфат <span className="font-normal">перевел(а)</span>{" "}
                        Лукман
                      </h2>
                      <p className="text-sm font-normal text-gray-600 dark:text-gray-400">
                ...
                <div className="inline-flex items-center gap-x-3">
                  ...
                  <div className="flex items-center gap-x-2">
                    <div>
                      ...
                      <p className="text-sm font-normal text-gray-600 dark:text-gray-400">
                        {" "}
                        <span className="font-medium"> Masha </span>
                        <span className="text-gray-500"> 2023-11-22 </span>
                      </p>
                    </div>
                  </div>
                ...
                <div className="inline-flex items-center gap-x-3">
                  ...
                  <div className="flex items-center gap-x-2">
                    <div>
                      ...
                      <p className="text-sm font-normal text-gray-600 dark:text-gray-400">
                        {" "}
                        <span className="font-medium"> Boris </span>
                        <span className="text-gray-500"> 2023-12-01 </span>
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <td className="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                <div className="inline-flex items-center gap-x-3">
                  ...
                  <div className="flex items-center gap-x-2">
                    <div>
                      <h2 className="font-medium text-gray-800 dark:text-white ">
                        Masha <span className="font-normal">перевел(а)</span>{" "}
                        Boris
                      </h2>
                      <p className="text-sm font-normal text-gray-600 dark:text-gray-400">
                        <span className="text-gray-500"> 2023-11-22 </span>
